...
```{r fig.cap = "Image credit: https://github.com/rfordatascience/tidytuesday/tree/main/data/2025", out.width='90%', fig.align='center', echo=FALSE}
knitr::include_graphics("images/tidytuesday1.png")
```

## TidyTuesday at Pomona

* Every Tuesday from 11-1pm
* Estella 2131
